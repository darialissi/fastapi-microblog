...
class TestComments:
    @pytest.mark.parametrize(
        ...
        [
            ("post", "/posts/1/comments", status.HTTP_201_CREATED, {
                                        "author_id": 1,
                                        "body": "test comment",
                                        }),      
            ("post", "/posts/1/comments", status.HTTP_422_UNPROCESSABLE_ENTITY, {
                                        "author_id": 0,
                                        "body": "test comment",
                                        }),      
            ("post", "/posts/5/comments", status.HTTP_400_BAD_REQUEST, {
                                        "author_id": 1,
                                        "body": "test comment",
                                        }),  
            ("patch", "/posts/1/comments/1", status.HTTP_200_OK, {
                                        "body": "new comment",
                                        }), 
            ("patch", "/posts/1/comments/5", status.HTTP_400_BAD_REQUEST, {
                                        "body": "new comment",
                                        }),   
